		...
		<div class="row">
			...
			<div class="col-md-9">
				<form action="AdminLogin" method="post">
					<div class="panel panel-default">
						<div class="panel-heading">Admin View All Medicine</div>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table">
									<tr>
				...
				%>
					<tr>
						...
						<td><%= resultSet.getDate("mfg_date") %></td>
						<td><%= resultSet.getDate("expiry") %></td>
						<td><a href="DeleteMedicine?id=<%= resultSet.getString("id") %>" style="color: blue;">Delete</a></td>
					</tr>
