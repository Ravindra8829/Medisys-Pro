...
<body>
	...
	<div style="margin-right: 5%; margin-left: 5%; margin-top: 5%;">
		<div class="row ">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line" align="center">Welcome- MediSys Pro</h4>
				</div>
			</div>
		</div>
	</div>
	<div style="margin-right: 5%; margin-left: 5%;">
		<div class="row">
			<div class="col-md-6">
				<img alt="" src="img/ms2.jpg" style="width: 100%; height: 80%">
			</div>
			<div class="col-md-6">
								...
								<table class="table">
									<tr>
										...
										<td><input type="text" class="form-control"
											placeholder="Your Email ID" required name="email"></td>
									</tr>
									<tr>
										<th>Password</th>
